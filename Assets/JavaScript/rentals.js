...
function abrirModal(idInmueble) {
    var xhr = new XMLHttpRequest();
    xhr.onreadystatechange = function () {
       if (xhr.readyState == 4 && xhr.status == 200) {
          document.getElementById("detalleModalContent").innerHTML = xhr.responseText;
          $('#detalleModal').modal('show');
       }
    };
    xhr.open("GET", "rentals.php?idInmueble=" + idInmueble, true);
    xhr.send();
 }